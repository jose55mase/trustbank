...
public class CommandRegistry {
     ...
     * Each command is upserted individually. On success, the command name is logged
     * at INFO level. On failure, the error is logged at ERROR level and registration
