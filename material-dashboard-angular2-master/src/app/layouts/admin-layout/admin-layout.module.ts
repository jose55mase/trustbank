...
import { RegisterProfileComponent } from 'app/register/register-profile.component';
...
@NgModule({
  ...
  declarations: [
    DashboardComponent, TransactionComponent, AccountsComponent, FilesComponent, LoginComponent,RegisterProfileComponent,
    AdminTransactionComponent,AdminUserProfileComponent,
